...
public class VoiceRecorder {
    ...
    public double voice_sum=0.0;

    private double avg_voice=0.0;
    private double min_voice=0.0;
    private double max_voice=0.0;
    ...
    */
    ...
    private class RecorderTask extends TimerTask {
        ...
        public void run() {
           ...
           // System.out.println("Voice: "+ String.format("%.2f", amplitudeDb));
           // System.out.println("\n\n");
