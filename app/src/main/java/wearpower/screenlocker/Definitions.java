...
//    final static public String file_name = "/data/data/wearpower.phonewatchcpuscreen/files/CpuConfLogs.log";
  ...
  //  final static public String file_name_upload = "/data/data/wearpower.displayfilter2/files/AllLogsUploads.gz";
    ...
    final static public String US_MODEL = "/data/data/wearpower.displayfilter2/files/screenStudyUsModel.arff";

     static public String ARFF_FILE_NAME = "/data/data/wearpower.displayfilter2/files/screenStudy.arff";
    //static public String ARFF_FILE_NAME = Context.getFilesDir().getPath();
    final static public String MODEL_NAMES = "/data/data/wearpower.displayfilter2/files/model.log";
